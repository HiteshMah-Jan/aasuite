 ...
 */
public class TOR extends AbstractSMSProcessor {
    //Transcript of Records TOR <Student Name>
    /**
     * 1. Send TOR to the mobile number of school or company
    ...
    public void run() {
        ...
        this.bean.code2 = BeanUtil.concat(lastname," ",firstname);
        ...
        //    this.server.addtoReply(this.bean.phoneNumber, AppConfig.getValue("SMS", "GMC", "TOR request acknowledge, please go here after 1 week for pick up."));
        //}
    }
}