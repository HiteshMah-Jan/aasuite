...
@UITemplate( gridCount=10, title="Subjects", 
    columnSearch={"schoolYear","preferredSemester","subject","preSubject","unit","finalRating","passed"},
    criteriaSearch={"subject","finalRating"}
...
public class StudentSubjectCollegeExt extends bean.person.StudentSubject implements Serializable {
