...
@ChildRecords({
    @ChildRecord(entity = StudentSubjectManualGradingQ2Ext.class, template=ChildTemplateListOnly.class, title="Q1", sql = "SELECT a FROM StudentSubject a WHERE a.scheduleId=${seq}", fieldMapping = {"seq", "scheduleId"}),
...
public class ScheduleManualGradingQ2Ext extends bean.Schedule implements Serializable {
