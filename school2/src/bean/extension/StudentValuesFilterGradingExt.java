 ...
 */
@UITemplate(
   template = TemplateLeftRight.class, showChart = false, showFiles = false,showImages=false,
    columnSearch={"faculty","gradeLevel","section","student","studentNumber"},
    criteriaSearch={"facultyId","gradeLevel","section","student"},
    gridCount=2, title="Student Values Grading", select="SELECT a FROM StudentValuesGrading a WHERE a.facultyId=${personId}",
    orderBy="a.student")
...
info = {
    ...
    displayFields = {""},hideGroup="3,4,5,6"),
     @ParentAddInfo(title = "Psychomotor Development  (Preschool)", gridCount = 2,
    displayFields = {""},hideGroup="2,4,5,6"),
    @ParentAddInfo(title = "Mega Skills  (Grade 1-4)", gridCount = 2,
    displayFields = {""},hideGroup="2,3,5,6"),
    @ParentAddInfo(title = "Values Promoted  (Grade 5-6/High School)", gridCount = 2,
    displayFields = {""},hideGroup="2,3,4,6"),
     @ParentAddInfo(title = "ZL2 Components  (Grade 5-6/High School)", gridCount = 2,
    displayFields = {""},hideGroup="2,3,4,5")
//    @ParentAddInfo(title = "Affective Development", gridCount = 2,
//    displayFields = {"kp","fh","fr","aw","ft","ic","ih","wi","id","in","de","wp","hs","ir","ls"}),
//    @ParentAddInfo(title = "Psychomotor Development", gridCount = 2,
//    displayFields = {"ap","ce","tc","cfp","df","wlr","cst","ocs","cwp","cp","pa"})
//    
})
    @DisplayGroups({
    
    @DisplayGroup(title = "Teacher's Comment", gridCount = 2, fields = {"comment1", "comment2","comment3","comment4"}),
    @DisplayGroup(title = "Misc Grades", gridCount = 4, fields = {"clubsAndParticipation", "scouting"}),
    //Affective Development count = 15
    @DisplayGroup(title = "Affective Development", gridCount = 10, fields = {"kp","kp2","kp3","kp4","kpFinal","fh","fh2","fh3","fh4","fhFinal","fr","fr2","fr3","fr4","frFinal","aw","aw2","aw3","aw4","awFinal","ft","ft2","ft3","ft4","ftFinal","ic","ic2","ic3","ic4","icFinal","ih","ih2","ih3","ih4","ihFinal","wi","wi2","wi3","wi4","wiFinal","id","id2","id3","id4","idFinal","neatAndOrganize","neatAndOrganize2","neatAndOrganize3","neatAndOrganize4","neatAndOrganizeFinal","de","de2","de3","de4","deFinal","wp","wp2","wp3","wp4","wpFinal","hs","hs2","hs3","hs4","hsFinal","ir","ir2","ir3","ir4","irFinal","ls","ls2","ls3","ls4","lsFinal"},addInfoOnly=true),
    //Psychomotor Development count = 11
    @DisplayGroup(title = "Psychomotor Development", gridCount = 10, fields = {"ap","ap2","ap3","ap4","apFinal","ce","ce2","ce3","ce4","ceFinal","tc","tc2","tc3","tc4","tcFinal","cfp","cfp2","cfp3","cfp4","cfpFinal","df","df2","df3","df4","dfFinal","wlr","wlr2","wlr3","wlr4","wlrFinal","cst","cst2","cst3","cst4","cstFinal","ocs","ocs2","ocs3","ocs4","ocsFinal","cwp","cwp2","cwp3","cwp4","cwpFinal","cp","cp2","cp3","cp4","cpFinal","pa","pa2","pa3","pa4","paFinal"},addInfoOnly=true),
    //Megaskills count = 10
    @DisplayGroup(title = "Mega Skills", gridCount = 10, fields = {"con","con2","con3","con4","conFinal", "mot","mot2","mot3","mot4","motFinal", "eff","eff2","eff3","eff4","effFinal", "res","res2","res3","res4","resFinal","ini","ini2","ini3","ini4","iniFinal", "per","per2","per3","per4","perFinal","car","car2","car3","car4","carFinal","tea","tea2","tea3","tea4","teaFinal","com","com2","com3","com4","comFinal","pro","pro2","pro3","pro4","proFinal"},addInfoOnly=true),
    //Values Promoted count = 14
    @DisplayGroup(title = "Values Promoted", gridCount = 10, fields = {"els","els2","els3","els4","elsFinal", "wfr", "wfr2", "wfr3", "wfr4", "wfrFinal", "apgw","apgw2","apgw3","apgw4","apgwFinal", "spaa","spaa2","spaa3","spaa4","spaaFinal","iva","iva2","iva3","iva4","ivaFinal", "isl","isl2","isl3","isl4","islFinal", "aspvi","aspvi2","aspvi3","aspvi4","aspviFinal", "hspd","hspd2","hspd3","hspd4","hspdFinal", "sd","sd2","sd3","sd4","sdFinal","put","put2","put3","put4","putFinal","hlew","hlew2","hlew3","hlew4","hlewFinal","prs","prs2","prs3","prs4","prsFinal","cr","cr2","cr3","cr4","crFinal","cws","cws2","cws3","cws4","cwsFinal"},addInfoOnly=true),
    //ZL2 Components count = 6
    @DisplayGroup(title = "ZL2 Components", gridCount = 10, fields = {"pfe","pfe2","pfe3","pfe4","pfeFinal","cra","cra2","cra3","cra4","craFinal","ca","ca2","ca3","ca4","caFinal","kin","kin2","kin3","kin4","kinFinal","ec1","ec12","ec13","ec14","ec1Final","ec2","ec22","ec23","ec24","ec2Final"},addInfoOnly=true)
...
@Displays({
   ...
   // @Display(name = "quarter", type="Combo", modelCombo={"1","2","3","4"},width=300),
    @Display(name = "comment1",width=400,label="1st Quarter Comment",type="TextArea2"),
    @Display(name = "comment2",width=400,label="2nd Quarter Comment",type="TextArea2"),
    @Display(name = "comment3",width=400,label="3rd Quarter Comment",type="TextArea2"),
    @Display(name = "comment4",width=400,label="4th Quarter Comment",type="TextArea2"),
    @Display(name = "clubsAndParticipation",width=50),
    ...
    @Display(name = "kpFinal", addInfoOnly = true, width = 30, labelTop = true, label = "Final"),
    ...
    @Display(name = "fhFinal", addInfoOnly = true, width = 30, hideLabel = true),
    ...
    @Display(name = "frFinal", addInfoOnly = true, width = 30, hideLabel = true),
    ...
    @Display(name = "awFinal", addInfoOnly = true, width = 30, hideLabel = true),
    ...
    @Display(name = "ftFinal", addInfoOnly = true, width = 30, hideLabel = true),
    ...
    @Display(name = "icFinal", addInfoOnly = true, label = "Is Confident", width = 30, hideLabel = true),
    ...
    @Display(name = "ihFinal", addInfoOnly = true, label = "Is Consistently Honest", width = 30, hideLabel = true),
    ...
    @Display(name = "wiFinal", addInfoOnly = true, label = "Works Independently", width = 30, hideLabel = true),
    ...
    @Display(name = "idFinal", addInfoOnly = true, label = "Is Dependable", width = 30, hideLabel = true),
    ...
    @Display(name = "neatAndOrganizeFinal", addInfoOnly = true, label = "Is Neat and Organized", width = 30, hideLabel = true),
    ...
    @Display(name = "deFinal", addInfoOnly = true, label = "Demonstrates Concern for Environment", width = 30, hideLabel = true),
    ...
    @Display(name = "wpFinal", addInfoOnly = true, label = "Works and Plays Well with Others", width = 30, hideLabel = true),
    ...
    @Display(name = "hsFinal", addInfoOnly = true, label = "Handles Varied Situations", width = 30, hideLabel = true),
    ...
    @Display(name = "irFinal", addInfoOnly = true, label = "Is Respectful to Others", width = 30, hideLabel = true),
    ...
    @Display(name = "lsFinal", addInfoOnly = true, label = "Listens While others Speak", width = 30, hideLabel = true), 
    ...
    @Display(name = "apFinal", addInfoOnly = true, label = "Actively Participates at Play", width = 30, hideLabel = true),
    ...
    @Display(name = "ceFinal", addInfoOnly = true, label = "Colors Evenly", width = 30, hideLabel = true),
    ...
    @Display(name = "tcFinal", addInfoOnly = true, label = "Traces Clearly", width = 30, hideLabel = true),
    ...
    @Display(name = "cfpFinal", addInfoOnly = true, label = "Can Follow Patterns", width = 30, hideLabel = true),
    ...
    @Display(name = "dfFinal", addInfoOnly = true, label = "Draws Recognizable Figures", width = 30, hideLabel = true),
    ...
    @Display(name = "wlrFinal", addInfoOnly = true, label = "Writes Following Left to Right Progression", width = 30, hideLabel = true),
    ...
    @Display(name = "cstFinal", addInfoOnly = true, label = "Is Concious of Stroke Terminals", width = 30, hideLabel = true),
    ...
    @Display(name = "ocsFinal", addInfoOnly = true, label = "Observes Correct Spacing", width = 30, hideLabel = true),
    ...
    @Display(name = "cwpFinal", addInfoOnly = true, label = "Copies with Precission", width = 30, hideLabel = true),
    ...
    @Display(name = "cpFinal", addInfoOnly = true, label = "Cuts Precisely", width = 30, hideLabel = true),
    ...
    @Display(name = "paFinal", addInfoOnly = true, label = "Pastes Accurately", width = 30, hideLabel = true),
    ...
    @Display(name = "conFinal", addInfoOnly = true, labelTop = true, label = "Final", width = 30),
    ...
    @Display(name = "motFinal", addInfoOnly = true, label = "Motivation", width = 30, hideLabel = true),
    ...
    @Display(name = "effFinal", addInfoOnly = true, label = "Effort", width = 30, hideLabel = true),
    ...
    @Display(name = "resFinal", addInfoOnly = true, label = "Responsiblity", width = 30, hideLabel = true),
    ...
    @Display(name = "iniFinal", addInfoOnly = true, label = "Initiative", width = 30, hideLabel = true),
    ...
    @Display(name = "perFinal", addInfoOnly = true, label = "Perseverance", width = 30, hideLabel = true),
    ...
    @Display(name = "carFinal", addInfoOnly = true, label = "Caring", width = 30, hideLabel = true),
    ...
    @Display(name = "teaFinal", addInfoOnly = true, label = "Teamwork", width = 30, hideLabel = true),
    ...
    @Display(name = "comFinal", addInfoOnly = true, label = "Common Sense", width = 30, hideLabel = true),
    ...
    @Display(name = "proFinal", addInfoOnly = true, label = "Problem Solving", width = 30, hideLabel = true),
    ...
    @Display(name = "elsFinal", addInfoOnly = true, labelTop = true, label = "Final", width = 30),
    ...
    @Display(name = "wfrFinal", addInfoOnly = true, label = "Wholesome Followership Role", width = 30, hideLabel = true),
    ...
    @Display(name = "apgwFinal", addInfoOnly = true, label = "Active Participation at Group Work", width = 30, hideLabel = true),
    ...
    @Display(name = "spaaFinal", addInfoOnly = true, label = "Knows and recites Simple Prayers", width = 30, hideLabel = true),
    ...
    @Display(name = "ivaFinal", addInfoOnly = true, label = "Integration of Values Acquired", width = 30, hideLabel = true),
    ...
    @Display(name = "islFinal", addInfoOnly = true, label = "Integration of Skills Learned", width = 30, hideLabel = true),
    ...
    @Display(name = "aspviFinal", addInfoOnly = true, label = "Active Sharing of Personal Views and Ideas", width = 30, hideLabel = true),
    ...
    @Display(name = "hspdFinal", addInfoOnly = true, label = "High Standards of Personal Discipline", width = 30, hideLabel = true),
    ...
    @Display(name = "sdFinal", addInfoOnly = true, label = "Self-directedness", width = 30, hideLabel = true),
    ...
    @Display(name = "putFinal", addInfoOnly = true, label = "Productive Use of Time", width = 30, hideLabel = true),
    ...
    @Display(name = "hlewFinal", addInfoOnly = true, label = "Highest Level of Excellence at Work", width = 30, hideLabel = true),
    ...
    @Display(name = "prsFinal", addInfoOnly = true, label = "Practical Recycling Skills", width = 30, hideLabel = true),
    ...
    @Display(name = "crFinal", addInfoOnly = true, label = "Creativity and Resourcefullness", width = 30, hideLabel = true),
    ...
    @Display(name = "cwsFinal", addInfoOnly = true, label = "Completion of Work Started", width = 30, hideLabel = true),
    ...
    @Display(name = "pfeFinal", addInfoOnly = true, labelTop = true, label = "Final", width = 30),
    ...
    @Display(name = "craFinal", addInfoOnly = true, label = "Career-related Activities", width = 30, hideLabel = true),
    ...
    @Display(name = "caFinal", addInfoOnly = true, label = "Creative Activities", width = 30, hideLabel = true),
    ...
    @Display(name = "kinFinal", addInfoOnly = true, label = "Kinesthetic", width = 30, hideLabel = true),
    ...
    @Display(name = "ec1Final", addInfoOnly = true, label = "Extra Curricular 1", width = 30,hideLabel=true),
    ...
    @Display(name = "ec2Final", addInfoOnly = true, label = "Extra Curricular 2", width = 30, hideLabel = true)
    
        
        
        
})
public class StudentValuesFilterGradingExt extends StudentValuesGrading implements Serializable {
}
