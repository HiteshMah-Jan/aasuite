...
@ChildRecords({
    @ChildRecord(entity = StudentSubjectManualGradingQ4Ext.class, template=ChildTemplateListOnly.class, title="Q1", sql = "SELECT a FROM StudentSubject a WHERE a.scheduleId=${seq}", fieldMapping = {"seq", "scheduleId"}),
...
public class ScheduleManualGradingQ4Ext extends bean.Schedule implements Serializable {
