...
public class JSPTemplate {
		...
		try {
	        ...
	        for (FieldCompose comp: lst) {
	        	...
	        	if (type.equals("Any")) {
		        	...
		        	js.append("\n\t$('#input").append(comp.field.getName()).append("').filter_input({regex:'[0-9.]'});");
	        	}
		        	...
		        	js.append("\n\t$('#input").append(comp.field.getName()).append("').time_input();");
	        	}
	        	else if (type.equals("Calendar")) {
		        	sb.append("\t\t").append(renderCalendar(comp)).append("\n");
		        	js.append("\n\t$('#input").append(comp.field.getName()).append("').datepicker();");
	        	}
	...
	protected String renderAny(FieldCompose f) {
		...
		sb.append("<div id='div").append(f.field.getName()).append("' class='divText'>")
			.append("<span>").append(PanelUtil.getLabel(f.field, f.display)).append("</span> <input type='text' name='").append(f.field.getName()).append("' class='inputText'/>")
			.append("</div>");
		return sb.toString();
	}
	protected String renderText(FieldCompose f) {
		...
		sb.append("<div id='div").append(f.field.getName()).append("' class='div").append(f.display.type()).append("'>")
			.append("<span>").append(PanelUtil.getLabel(f.field, f.display)).append("</span> <input type='text' name='").append(f.field.getName()).append("' class='input").append(f.display.type()).append("'/>")
			.append("</div>");
		return sb.toString();
	}
	...
	protected String renderText2(FieldCompose f) {
		StringBuffer sb = new StringBuffer();
		sb.append("<div id='div").append(f.field.getName()).append("' class='div").append(f.display.type()).append("'>")
			.append("<span>").append(PanelUtil.getLabel(f.field, f.display)).append("</span> <textarea name='").append(f.field.getName()).append("' class='input").append(f.display.type()).append("'></textarea>")
			.append("</div>");
		return sb.toString();
	}
	...
	protected String renderCheckBox(FieldCompose f) {
		StringBuffer sb = new StringBuffer();
		sb.append("<div id='div").append(f.field.getName()).append("' class='div").append(f.display.type()).append("'>")
			.append("<span>").append(PanelUtil.getLabel(f.field, f.display)).append("</span> <input type='checkbox' name='").append(f.field.getName()).append("' class='input").append(f.display.type()).append("'/>")
			.append("</div>");
		return sb.toString();
	}
	protected String renderCombo(FieldCompose f) {
		...
		sb.append("<select name='").append(f.field.getName()).append("' class='input").append(f.display.type()).append("'>");
		for (String s:arr) {
	...
	protected String renderPopSearch(FieldCompose f) {
		StringBuffer sb = new StringBuffer();
		sb.append("<div id='div").append(f.field.getName()).append("' class='div").append(f.display.type()).append("'>")
			.append("<span>").append(PanelUtil.getLabel(f.field, f.display)).append("</span> <input type='text' name='").append(f.field.getName()).append("' class='input").append(f.display.type()).append("' entity='").append(f.display.linktoBean().getSimpleName()).append("'/>")
			.append("</div>");
		return sb.toString();
	}
