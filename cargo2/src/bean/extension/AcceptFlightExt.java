...
@template.ActionButtons({
    @template.ActionButton(name="btnAcceptULD", label="Accept ULD"),
    @template.ActionButton(name="btnAcceptFlight", label="Accept Flight"),
    @template.ActionButton(name="btnShowNotoc", label="Show Notoc"),
    @template.ActionButton(name="btnShowMessages", label="Show Messages")
})
public class AcceptFlightExt extends bean.Flight {
	public static void main(String[] args) {
		view(AcceptFlightExt.class);
	}
}
