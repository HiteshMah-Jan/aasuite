 ...
 */
@UITemplate(template = TemplateTabPage.class, gridCount = 4, sumFooter="3,4,5",
		columnSearch = {"awb", "flightDesc", "pieces", "weight", "volume", "status", "importStatus", "shc1", "shc2"},
...
public class AwbFltBuildUpDetailExt extends AwbFlt {
}
