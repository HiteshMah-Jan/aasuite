...
@UITemplate(template = TemplateDefault.class, gridCount = 4, columnSearch = {"salesQuotationId", "product", "totalAmount"})
@Displays({
        @Display(name="seq"),
        @Display(name="salesQuotationId"),
...
public class SalesQuotationItem extends AbstractIBean implements Serializable {

    @Id
    @Column(name = "seq", nullable = false)
    public Integer seq;
    @Column(name = "salesQuotationId", nullable = false)
