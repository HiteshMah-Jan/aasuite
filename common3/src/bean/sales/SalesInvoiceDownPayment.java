...
import bean.sales.embedded.EmbeddedSalesInvoiceLogistics;
 ...
 */
@Entity
@Table(name = "SalesInvoiceDownPayment")
...
@ChildRecords(
		value={
				@ChildRecord(template=ChildTemplateListPopupDownButton.class,entity=SalesInvoiceDownPaymentItem.class, fieldMapping={"seq","salesInvoiceDownPaymentId"}, sql="SELECT a FROM SalesInvoiceDownPaymentItem a WHERE a.salesInvoiceDownPaymentId=${seq}", title="Contents")
		},
		info={
...
public class SalesInvoiceDownPayment extends AbstractIBean implements Serializable {
	public static void main(String[] args) {
		view(SalesInvoiceDownPayment.class);
	}
	
	@Override
    public void save() {
		this.logistics = ((SalesInvoiceDownPayment)myClone).logistics;
		this.accounting = ((SalesInvoiceDownPayment)myClone).accounting;
        super.save();
    }
...
//    below are for logistics
    @Embedded
    public EmbeddedSalesInvoiceLogistics logistics = new EmbeddedSalesInvoiceLogistics();
    @Embedded
	...
	public EmbeddedSalesInvoiceLogistics getLogistics() {
		return logistics;
	}

	public void setLogistics(EmbeddedSalesInvoiceLogistics logistics) {
