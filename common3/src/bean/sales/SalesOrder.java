...
@UITemplate(template = TemplateDefault.class, gridCount = 4, columnSearch = {"accountType", "deposit"})
@Displays({
...
//    below are for logistics
    @Embedded
    public EmbeddedSalesLogistics logistics = new EmbeddedSalesLogistics();
    @Embedded
	...
	public EmbeddedSalesLogistics getLogistics() {
		return logistics;
	}

	public void setLogistics(EmbeddedSalesLogistics logistics) {
