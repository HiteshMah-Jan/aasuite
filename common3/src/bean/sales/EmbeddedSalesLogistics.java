...
@Displays({
    	@Display(name="dummyField", type="MergePanel", label="Bill", fieldPrefix="logistics.", mergeFields={"billToContact","billToStreet","billToBuilding","billToCity","billToZipCode","billToCounty","billToState","billToCountry"}, verticalMerge=true),
...
//        @Display(name="billToBlock", fieldPrefix="logistics.", label="Block"),
        ...
        @Display(name="dummyField", type="MergePanel", label="Ship", fieldPrefix="logistics.", mergeFields={"shipToContact","shipToStreet","shipToBuilding","shipToCity","shipToZipCode","shipToCounty","shipToState","shipToCountry"}, verticalMerge=true),
...
//        @Display(name="shipToBlock", fieldPrefix="logistics.", label="Block"),
        ...
        @Display(name="allowPartialDelivery", fieldPrefix="logistics.")
        
})
public class EmbeddedSalesLogistics extends AbstractIBean {
	public static void main(String[] args) {
		viewEmbedded(EmbeddedSalesLogistics.class);
	}
