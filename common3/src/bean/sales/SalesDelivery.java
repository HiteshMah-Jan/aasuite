...
@ChildRecords(
		value={
				@ChildRecord(template=ChildTemplateListPopupDownButton.class,entity=SalesDeliveryItem.class, fieldMapping={"seq","salesDeviveryId"}, sql="SELECT a FROM SalesDeliveryItem a WHERE a.salesDeliveryId=${seq}", title="Contents")
		},
		info={
...
public class SalesDelivery extends AbstractIBean implements Serializable {
	public static void main(String[] args) {
		view(SalesDelivery.class);
	}
	
	@Override
    public void save() {
		this.logistics = ((SalesDelivery)myClone).logistics;
		this.accounting = ((SalesDelivery)myClone).accounting;
        super.save();
    }
