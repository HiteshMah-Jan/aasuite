...
//        @Display(name="shipToCounty", fieldPrefix="logistics.", label="County"),
        ...
        @Display(name="dummyField", type="MergePanel", noLabel=false, fieldPrefix="logistics.", 
        		mergeFields={"shippingType","pickAndPackRemarks","bpChannelName","bpChannelContact","trackingNumber","blockDunningLetters"}, verticalMerge=true),
...
//        @Display(name="dummyField", type="MergePanel", noLabel=true, fieldPrefix="logistics.", mergeFields={"trackingNumber","blockDunningLetters"}, verticalMerge=true),
        @Display(name="trackingNumber", fieldPrefix="logistics."),
        @Display(name="blockDunningLetters", fieldPrefix="logistics.")
        
})
public class EmbeddedSalesInvoiceLogistics extends AbstractIBean {
	public static void main(String[] args) {
		viewEmbedded(EmbeddedSalesInvoiceLogistics.class);
	}
    ...
    public String blockDunningLetters;
	...
	public String getBlockDunningLetters() {
		return blockDunningLetters;
	}


	public void setBlockDunningLetters(String blockDunningLetters) {
		this.blockDunningLetters = blockDunningLetters;
	}
