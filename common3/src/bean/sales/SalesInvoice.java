...
@ChildRecords(
		value={
				@ChildRecord(template=ChildTemplateListPopupDownButton.class,entity=SalesInvoiceItem.class, fieldMapping={"seq","salesInvoiceId"}, sql="SELECT a FROM SalesInvoiceItem a WHERE a.salesInvoiceId=${seq}", title="Contents")
		},
		info={
...
public class SalesInvoice extends AbstractIBean implements Serializable {
	public static void main(String[] args) {
		view(SalesInvoice.class);
	}
	
	@Override
    public void save() {
		this.logistics = ((SalesInvoice)myClone).logistics;
		this.accounting = ((SalesInvoice)myClone).accounting;
        super.save();
    }
