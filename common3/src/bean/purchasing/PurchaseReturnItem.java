...
@UITemplate(template = TemplateDefault.class, gridCount = 4, columnSearch = {"purchaseReturnId", "product", "totalAmount"})
@Displays({
        @Display(name="seq"),
...
public class PurchaseReturnItem extends AbstractIBean implements Serializable {

    @Id
    @Column(name = "seq", nullable = false)
    public Integer seq;
    @Column(name = "purchaseReturnId", nullable = false)
