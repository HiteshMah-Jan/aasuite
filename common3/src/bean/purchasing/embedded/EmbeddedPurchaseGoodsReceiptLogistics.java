package bean.purchasing.embedded;
...
//        @Display(name="shipToCounty", fieldPrefix="logistics.", label="County"),
        ...
        @Display(name="dummyField", type="MergePanel", noLabel=false, fieldPrefix="logistics.", mergeFields={"shippingType","splitPourchaseOrder","approved"}, verticalMerge=true),
        @Display(name="shippingType", type="Combo", sqlCombo="SELECT a FROM ShippingType a", fieldPrefix="logistics."),
        @Display(name="splitPourchaseOrder", fieldPrefix="logistics."),
        @Display(name="approved", fieldPrefix="logistics.")
        
})
public class EmbeddedPurchaseGoodsReceiptLogistics extends AbstractIBean {
	public static void main(String[] args) {
		viewEmbedded(EmbeddedPurchaseGoodsReceiptLogistics.class);
	}
    ...
    public String splitPourchaseOrder;
	...
	public String getSplitPourchaseOrder() {
		return splitPourchaseOrder;
	}


	public void setSplitPourchaseOrder(String splitPourchaseOrder) {
		this.splitPourchaseOrder = splitPourchaseOrder;
	}
