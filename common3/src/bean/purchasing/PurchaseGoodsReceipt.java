...
import bean.purchasing.embedded.EmbeddedPurchaseGoodsReceiptLogistics;
 ...
 */
@Entity
@Table(name = "PurchaseGoodsReceipt")
...
public class PurchaseGoodsReceipt extends AbstractIBean implements Serializable {
	public static void main(String[] args) {
		view(PurchaseGoodsReceipt.class);
	}
	
	@Override
    public void save() {
		this.logistics = ((PurchaseGoodsReceipt)myClone).logistics;
		this.accounting = ((PurchaseGoodsReceipt)myClone).accounting;
        super.save();
    }
...
//    below are for logistics
    @Embedded
    public EmbeddedPurchaseGoodsReceiptLogistics logistics = new EmbeddedPurchaseGoodsReceiptLogistics();
    @Embedded
	...
	public EmbeddedPurchaseGoodsReceiptLogistics getLogistics() {
		return logistics;
	}

	public void setLogistics(EmbeddedPurchaseGoodsReceiptLogistics logistics) {
