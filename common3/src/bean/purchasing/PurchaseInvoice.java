...
@ChildRecords(
		value={
				@ChildRecord(template=ChildTemplateListPopupDownButton.class,entity=PurchaseInvoiceItem.class, fieldMapping={"seq","purchaseInvoiceId"}, sql="SELECT a FROM PurchaseInvoiceItem a WHERE a.purchaseInvoiceId=${seq}", title="Contents")
		},
		info={
...
public class PurchaseInvoice extends AbstractIBean implements Serializable {
	public static void main(String[] args) {
		view(PurchaseInvoice.class);
	}
	
	@Override
    public void save() {
		this.logistics = ((PurchaseInvoice)myClone).logistics;
		this.accounting = ((PurchaseInvoice)myClone).accounting;
        super.save();
    }
