...
import bean.purchasing.embedded.EmbeddedPurchaseInvoiceLogistics;
 ...
 */
@Entity
@Table(name = "PurchaseInvoiceDownPayment")
...
@ChildRecords(
		value={
				@ChildRecord(template=ChildTemplateListPopupDownButton.class,entity=PurchaseInvoiceItem.class, fieldMapping={"seq","purchaseInvoiceDownPaymentId"}, sql="SELECT a FROM PurchaseInvoiceDownPaymentItem a WHERE a.purchaseInvoiceDownPaymentId=${seq}", title="Contents")
		},
		info={
...
public class PurchaseInvoiceDownPayment extends AbstractIBean implements Serializable {
	public static void main(String[] args) {
		view(PurchaseInvoiceDownPayment.class);
	}
	
	@Override
    public void save() {
		this.logistics = ((PurchaseInvoiceDownPayment)myClone).logistics;
		this.accounting = ((PurchaseInvoiceDownPayment)myClone).accounting;
        super.save();
    }
...
//    below are for logistics
    @Embedded
    public EmbeddedPurchaseInvoiceLogistics logistics = new EmbeddedPurchaseInvoiceLogistics();
    @Embedded
	...
	public EmbeddedPurchaseInvoiceLogistics getLogistics() {
		return logistics;
	}

	public void setLogistics(EmbeddedPurchaseInvoiceLogistics logistics) {
