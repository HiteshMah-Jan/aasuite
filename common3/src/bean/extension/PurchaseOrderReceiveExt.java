...
@UITemplate(template = TemplateTabSinglePage.class, gridCount = 4, columnSearch = {
		"purchaseDate", "purchaseFrom", "totalPOAmount" }, select="SELECT a FROM PurchaseOrder a WHERE a.approvedBy2 IS NOT NULL OR a.receivedBy IS NOT NULL")
...
public class PurchaseOrderReceiveExt extends PurchaseOrder {
	public static void main(String[] args) {
		view(PurchaseOrderReceiveExt.class);
	}
}
