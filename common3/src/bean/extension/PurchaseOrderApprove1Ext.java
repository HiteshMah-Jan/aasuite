...
@UITemplate(template = TemplateTabSinglePage.class, gridCount = 4, columnSearch = {
		"purchaseDate", "purchaseFrom", "totalPOAmount" }, select="SELECT a FROM PurchaseOrder a WHERE a.approvedBy2 IS NULL AND a.receivedBy IS NULL")
...
public class PurchaseOrderApprove1Ext extends PurchaseOrder {
	public static void main(String[] args) {
		view(PurchaseOrderApprove1Ext.class);
	}
}
