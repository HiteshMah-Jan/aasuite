...
@UITemplate(template = TemplateTabSinglePage.class, gridCount = 4, columnSearch = {
		"purchaseDate", "purchaseFrom", "totalPOAmount" }, select="SELECT a FROM PurchaseOrder a WHERE a.receivedBy IS NULL")
...
public class PurchaseOrderRequestExt extends PurchaseOrder {
	public static void main(String[] args) {
		view(PurchaseOrderRequestExt.class);
	}
}
