...
@UITemplate(template = TemplateTabSinglePage.class, gridCount = 4, columnSearch = {
		"purchaseDate", "purchaseFrom", "totalPOAmount" }, select="SELECT a FROM PurchaseOrder a WHERE a.approvedBy IS NOT NULL AND a.receivedBy IS NULL")
...
public class PurchaseOrderApprove2Ext extends PurchaseOrder {
	public static void main(String[] args) {
		view(PurchaseOrderApprove2Ext.class);
	}
}
