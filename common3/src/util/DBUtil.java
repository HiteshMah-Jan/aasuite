...
public class DBUtil {
    ...
    public static void setupDerby() {
    	mapKey.put("javax.persistence.jdbc.user","");
        mapKey.put("javax.persistence.jdbc.password","");
        mapKey.put("javax.persistence.jdbc.url","jdbc:derby:derbyDB;create=true");
        mapKey.put("javax.persistence.jdbc.driver","org.apache.derby.jdbc.EmbeddedDriver");
        mapKey.put("eclipselink.jdbc.write-connections.max","1");
    }
