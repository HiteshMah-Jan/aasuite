...
@Entity
@Table(name = "Person")
@UITemplate(template = TemplateTabPage.class, gridCount = 6, columnSearch = {"lastName", "firstName","department"},showImages=true)
@ChildRecords(
    value={
...
@Displays({
        ...
        @Display(name="department",type="Combo",linktoBean=Department.class),
...
public class EmployeeSchoolAdmin extends EmployeeSchool implements Serializable {
}
