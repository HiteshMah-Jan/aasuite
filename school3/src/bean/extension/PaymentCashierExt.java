...
@Displays({
        ...
        @Display(name="surcharge", type="Label", label="NetSurcharge\n(+)"),
        @Display(name="discount", type="Label", label="Discount\n(-)"),
        @Display(name="amountPaid", type="Label", label="Total Amount\n(Payment)"),
...
public class PaymentCashierExt extends bean.accounting.PaymentEnrollment implements Serializable {
    public static void main(String[] args) {
        view(PaymentCashierExt.class);
    }
}