...
showChart = false, select="SELECT a FROM Enrollment a WHERE a.college=true")
@ChildRecords(value = {
...
info = {
//}),
    @template.ParentAddInfo(title = "Enrollment Info",displayFields = {}, hideGroup="2"),
    @template.ParentAddInfo(title = "Schedules",displayFields = { }, hideGroup="0,1")
})
@Displays({
    @Display(name = "studentId", linktoBean = StudentCollegeExt.class, label = "Student", gridFieldWidth = 3, width = -1, type = "PopSearch"),
    @Display(name = "schoolYear", enabled=false),
    @Display(name = "section", type = "PopSearch", linktoBean = SectionCollegeExt.class),
//    @Display(name = "semester",type="Combo", modelCombo={"1", "2", "3"}, addInfoOnly=true),
    @Display(name = "paymentPlanType", type="Combo", label="Plan", modelCombo={"S","Q","M"},width=-1),
...
@DisplayGroups({
        @DisplayGroup(gridCount = 4, title = "Student Info", fields = {
    		"studentId","schoolYear","section","semester","paymentPlanType","totalUnits","totalAmount","overAllAmount"
        },addInfoOnly = true),
        @DisplayGroup(gridCount = 4, title = "Miscellaneous Info", fields = {
...
public class CollegeEnrollmentStudentExt extends Enrollment {
	public CollegeEnrollmentStudentExt() {
        accountNumber = "102";
        paymentStatus = "NEW";
	...
	public static void main(String[] args) {
        view(CollegeEnrollmentStudentExt.class);
    }
