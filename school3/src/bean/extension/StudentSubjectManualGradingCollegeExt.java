 ...
 */
@UITemplate(
    columnSearch={"studentName","grade1"}, 
...
public class StudentSubjectManualGradingCollegeExt extends StudentSubject {
    public static void main(String[] args) {
        view(StudentSubjectManualGradingCollegeExt.class);
    }
}
