...
//    @Display(name = "plan", width=-1, type="Label", maxChar=20),
    @Display(name = "status", width=100, type="Combo", modelCombo={"ENROLLED","NOT ENROLLED","OFF. DROP","UNOFF. DROP"}),
    @Display(name = "paymentStatus", label = "Check", width=-1, maxChar=20)
})
public class StudentSnapshotExt extends bean.Student implements Serializable {
    public static void main(String[] args) {
        view(StudentSnapshotExt.class);
    }
}
