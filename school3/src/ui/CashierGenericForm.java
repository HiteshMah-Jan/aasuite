...
public class CashierGenericForm extends AbstractCashierForm {
    ...
    public static void main(String[] args) {
        ...
        UserInfo.weblogin("ALEX", "PASSWORD");
        PanelUtil.displayToFrame(new CashierGenericForm());
    }

    public CashierGenericForm() {
        super();
        ...
        this.addWindow("Book", new ui.cashier.BookPayment());
