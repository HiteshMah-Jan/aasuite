 ...
 */
@UITemplate(template=template.screen.TemplateTabPage.class, showChart=true, title="Collected", gridCount=8, 
    columnSearch = {"cashier","paidBy", "dueDate", "amount", "paid", "paymentDate"}, 
    select="SELECT a FROM Payment a WHERE a.paid=true ", orderBy="a.paymentDate")
@Displays({
...
public class PaymentAllExt extends bean.accounting.Payment implements Serializable {
