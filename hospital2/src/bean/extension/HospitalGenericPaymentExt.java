...
@Displays({
        @Display(name="paidBy", type="PopSearch", linktoBean=Patient.class, label="Customer", gridFieldWidth=5, width=-1),
...
public class HospitalGenericPaymentExt extends PaymentGeneric {
    public static void main(String[] args) {
        view(HospitalGenericPaymentExt.class);
    }
    
    public HospitalGenericPaymentExt() {
        accountNumber = "102";
