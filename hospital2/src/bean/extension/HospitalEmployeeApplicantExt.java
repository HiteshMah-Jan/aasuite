...
@ChildRecords(
    ...
    info={
        @ParentAddInfo(title="Additional Information", displayFields={"hiredDate", "email","birthDate","gender","age","citizenship","sssNumber","maritalStatus","religion","address", "contactNumber","placeOfBirth","tinNumber","pagibigNumber","philhealthNumber","address1","contactNumber1"})
}
)
@Displays({
...
public class HospitalEmployeeApplicantExt extends JobApplicant {
