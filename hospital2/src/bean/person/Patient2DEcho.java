...
@UITemplate(template=TemplateTabPage.class, columnSearch={""})
@DiscriminatorValue(value = "2DECHO")
@Displays({
...
public class Patient2DEcho extends PatientUltrasound implements Serializable {
}
