...
@DiscriminatorValue("CTSCAN")
@UITemplate(template = TemplateTabPage.class, gridCount = 4, columnSearch = {"radiologist", "radiologyType", "patient"})
@Displays({
...
public class PatientCTScan extends PatientRadiology implements Serializable {
}
