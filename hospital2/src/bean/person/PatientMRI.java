...
@DiscriminatorValue(value = "MRI")
@UITemplate(template = TemplateTabPage.class, gridCount = 4, columnSearch = {"radiologist"})
@Displays({
...
public class PatientMRI extends PatientRadiology implements Serializable {
}
