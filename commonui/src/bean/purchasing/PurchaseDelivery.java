 ...
 */
@Entity
@Table(name = "PurchaseDelivery")
public class PurchaseDelivery extends AbstractIBean implements Serializable {
    @Id
    @Column(name = "seq")
    public Integer seq;
    @Embedded
    ...
    List<PurchaseDeliveryItem> items;
	...
	public List<PurchaseDeliveryItem> getItems() {
		return items;
	}

	public void setItems(List<PurchaseDeliveryItem> items) {
		this.items = items;
	}
}
