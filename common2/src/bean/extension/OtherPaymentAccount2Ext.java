...
//	    @Display(name = "orType", label = "Acc", type="Label"),
	    ...
	    @Display(name = "paymentCode1",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, label = "Payment Code", labelTop = true),
	    @Display(name = "paymentAmount1", label = "Amount Paid", labelTop = true),
	    @Display(name = "paymentCode2",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount2", hideLabel = true),
	    @Display(name = "paymentCode3",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount3", hideLabel = true),
	    @Display(name = "paymentCode4",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount4", hideLabel = true),
	    @Display(name = "paymentCode5",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount5", hideLabel = true),
	    @Display(name = "paymentCode6",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount6", hideLabel = true),
	    @Display(name = "paymentCode7",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount7", hideLabel = true),
	    @Display(name = "paymentCode8",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount8", hideLabel = true),
	    @Display(name = "paymentCode9",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
	    @Display(name = "paymentAmount9", hideLabel = true),
	    @Display(name = "paymentCode10",width=300, type = "PopSearch", linktoBean = OtherPaymentReferenceAccount2Ext.class, hideLabel = true),
...
public class OtherPaymentAccount2Ext extends OtherPayment {
    public OtherPaymentAccount2Ext() {
    	orType = "A";
    }
}
